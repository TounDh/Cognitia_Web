 ...
 */
final class Version20250219170639 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE date_actuelle date_actuelle DATETIME DEFAULT \'current_timestamp()\' NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE cours ADD instructeur_id INT NOT NULL, ADD image VARCHAR(255) DEFAULT \'NULL\', ADD date_publication DATETIME NOT NULL, DROP image_data, CHANGE description description LONGTEXT NOT NULL, CHANGE difficulte difficulte VARCHAR(255) NOT NULL, CHANGE duree duree INT NOT NULL, CHANGE prix prix NUMERIC(10, 2) NOT NULL');
