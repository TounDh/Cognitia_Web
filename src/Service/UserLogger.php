...
class UserLogger
{
    ...
    public function log(?User $user, string $action, ?string $details = null, ?array $modifiedFields = null): void
        {
            ...
            $log->setModifiedFields($modifiedFields); // Enregistrer les champs modifiés
